 ...
 * Redirect slider
 */
class CTAButton_Redirect_Slider implements CTAButton_Slider_Interface {
    ...
    public function render() {
		...
		if($settings['enabled'] && $settings['showOnCurrentPage']) {
            ...
            ?>
            <div class="sheet-redirect">
                <div>
                    <h4>
                        <?php echo esc_html( isset($settings['title']) ? $settings['title'] : '' ); ?>
                    </h4>
                    <p style="color: #000;"><?php echo esc_html( $settings['description'] ); ?></p>
    ...
    public function get_settings() {
        $values             = get_option( $this->plugin_name.'-settings-redirect' );
